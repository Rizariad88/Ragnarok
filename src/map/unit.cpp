 ...
 */
void unit_run_hit(struct block_list *bl, struct status_change *sc, map_session_data *sd, enum sc_type type)
{
...
//==========================================
bool k_tick_check(map_session_data *sd, t_tick k_tick_t, int k_tick_c, int kdelay_n, int kdelay_w) {
	char msg[200];
	int m_castle = 0;
