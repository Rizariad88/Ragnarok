...
enum _sp {
	...
	// <Epoque>
	,
	SP_CHANGERACE = 3100, SP_ADD_HOMINTIMACY, SP_ADD_SKILLMOVE, SP_ADD_TRAPEVADE, SP_MAGICAREA_DEF_RATE, SP_MAGICSINGLE_DEF_RATE, // 3100-3105
	SP_ADD_CRITICALEVADE, SP_KEEPBUFFS, SP_ADD_IGNOREGTB, SP_ADD_CRITICALDODGE, SP_ADD_AREASKILL, SP_SKILL_GAINSP, SP_ADD_STATUSDAMAGE, // 3106-3112
	SP_ADD_STATUSRESIST, SP_ADD_STATUSSWITCH, SP_HEALATTACK, SP_MDEF_RATIO_ATK_ELE, SP_MDEF_RATIO_ATK_RACE, SP_HP_ATK_RATIO, SP_SP_ATK_RATIO, // 3113-3119
	SP_ATK_EMOTION, SP_ADD_STATUSRATE, SP_IGNORE_SKILL_DEF_ELE, SP_IGNORE_SKILL_DEF_RACE, SP_SWITCHPLACE, SP_WIDESTATUS, SP_WIDESTATUS_ONHIT, // 3120-3126
	SP_SKILLCHAIN, SP_SKILLBOUNCE, SP_SUBJOB, SP_ADDJOB, SP_ADD_MONSTERDROPITEMATK, SP_ADD_MONSTERDROPITEMGROUPATK, SP_ADD_RACEDROPITEMATK, // 3127-3133
	SP_ADD_CLASSDROPITEMATK, SP_ADD_SELFDROPITEMATK, SP_ADD_SELFDROPITEMGROUPATK, SP_ADD_STATUS, SP_ADD_PETINTIMACY, SP_INTERRUPT, SP_INVERT, // 3134-3140
	SP_BREAK_EQUIP, SP_CHANGESIZE, SP_MULTIDROP, SP_DOUBLECAST, SP_IGNOREFLEE, SP_DEATH, SP_WATERATKRATE, SP_WATERMATKRATE, SP_GRAVITY, // 3141-3149
	SP_NOCHAT, SP_NOCONSUME, SP_NOAMMO, SP_SNAPMOVE, SP_ZENYATTACK, SP_ITEMATTACK, SP_AUTOLIFE, SP_DAMAGELIMIT, SP_HPLIMIT, SP_SPLIMIT, // 3150-3159
	SP_ATKRATECHANCE, SP_MATKRATECHANCE, SP_NOEQUIP, SP_WEAPONDEF, SP_ELEMENTLV, SP_SKILLHPCOST, SP_SKILLITEMCOST, SP_DURABILITYDEF, // 3160-3167

	// Stormbreaker
	SP_AUTOHPUSE, SP_AUTOSPUSE, SP_AUTOSTATUSUSE, SP_NOITEMUSE, SP_NOSKILLUSE, SP_NOWALK, SP_UNDETECTABLE, SP_SKILLREQUIRECOST, // 3168-3175
	SP_ITEMHPTOSP, SP_ITEMSPTOHP, SP_ZENYCOST, SP_HPCOST,
};
